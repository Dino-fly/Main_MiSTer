...
trivial geometry: a ring, a triangle, a square, a cross, and four letters. Derek drew a
...
#
# What a Super Famicom pad actually looks like, and the shape Derek described: a circle
