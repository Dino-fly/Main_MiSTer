...
/*
  ...
  the only way to it is the disc dialog, which is what Derek decided the disc's one entry
...
/*
  ...
  Measured on Derek's own set with a real scanned label in the dialog: at 32 px across the
...
static void disc_layout_for(const chome_profile *p, const disc_dlg *d, disc_layout *L)
{
	...
	*/
	...
	/*
	  ...
	  Derek: "they probably should not have an immense dialog covering most of the screen at
	...
	*/
	...
	/*
	  ...
	  grounds that stretching it to the inset left half of it empty. Then Derek asked for
