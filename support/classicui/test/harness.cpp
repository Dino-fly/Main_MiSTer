...
static void assert_disc_hires()
{
	...
	*/
	...
	/*
	  ...
	  two sides swapped, and the scan is the side Derek sees once his credentials fetch real art.
...
/*
  ...
  Derek: "we might still need to fix it for higher resolutions if they show more of the
  ...
  Three things are pinned here and the third is the reason the other two are safe to change:
    ...
    - 240p, which must be what it was to the pixel. It is Derek's own screen, he likes the
...
/*
  ...
  that path - so Down landed on whatever the shelf happened to be showing, which for Derek
...
/*
  ...
  this fixture imitates carried our real devid, our real devpassword and Derek's own
...
static void assert_screenscraper()
{
	...
	*/
	...
	check(strstr(url, "ssid=derek") != 0, "the user's own account is sent");
	...
	*/
	...
	/*
	  ...
	  try again later.
	*/
	put_file("/tmp/chome_ss_nogame.xml", "<Data><ssuser><id>derek</id></ssuser></Data>\n");
	...
	*/
...

	{
		...
		/*
		  The fallback Derek asked for, on the data that motivated it. The real reply
...
/*
  ...
  Derek's account allows a single thread, so a stray fetch is not a slow test but a request
  ...
  the ssuser block, which is copied from the shape of the reply Derek read on 2026-08-05.
*/
...
static void assert_art_ladder()
{
	...
	*/
	...
	/*
	  The other half of Derek's instruction, and the half his words did not say outright.
...
/*
  ...
  front-end throwing the player out for pressing Save; SMS is the first core Derek owns that
...
static void assert_core_options_screen()
{
	...
	*/
	...
	/*
	  ...
	  this picture shows Palette next to VI Deblur, a combination no real core has. Derek
...
static void assert_per_game_core_options()
{
	...
	*/
	...
	/*
	  Widescreen Hack is the second row of the picture page, and it is the option Derek
...
static void assert_ingame()
{
	...
	*/
	...
	/*
	  ...
	  Derek's point, and worth a check of its own because the two conditions are set in
...
/*
  ...
  that has been on Derek's CRT since the beginning, and what the stretched canvas has to
	...
	printf("\n== waiting: activity and progress ==\n");
	{
		...
		*/
		...
		/*
		  ...
		  and they are also the profile Derek's own set gets - so the pictures are the
	...
	*/
	printf("\n== controller prompts ==\n");
	{
		...
		*/
		...
		/*
		  The names these pads use over Bluetooth, which is how Derek's are paired. Read
