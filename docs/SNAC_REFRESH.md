...
Read `/Users/mister/workspace/snac-build` before changing anything here. It is
...
python3 tools/snac_farm/stale.py --list > /Users/mister/workspace/snac-refresh/rebuild.txt
WIN=dinoi@192.168.1.23 JOB=snacjob_r0 NPROC=2 \
  tools/snac_farm/build_via_windows_snac.sh /Users/mister/workspace/snac-refresh/rebuild.txt
```
